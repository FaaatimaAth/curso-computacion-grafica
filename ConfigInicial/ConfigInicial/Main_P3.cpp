//Previo 3
//Marquez Martinez Fatima Athiziri
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 3. Marquez Martinez Fatima Athziri", nullptr, nullptr);
	...
	//Vertices que define las caras de los cubos 
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,0.0f,-12.0f));
		...
		//Variables que permiten mandar informacion del codigo base al shader 
