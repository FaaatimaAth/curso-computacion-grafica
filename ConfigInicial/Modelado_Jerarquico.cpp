...
//For model
float	hombro = 0.0f, codo = 0.0f, muneca = 0.0f, dedo1, dedo2; 
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 05. Marquez Maertinez Fatima Athziri", nullptr, nullptr);
